...
public class BgCaseControllerTest {

	@Autowired
	private BgCaseController controller;
	@Test
	public void testList() throws Exception {
		Model m = new BindingAwareModelMap();
		controller.list(new BgCase(), new MockHttpServletRequest(), new MockHttpServletResponse(),m );
	}
}
