...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/bg/bgCustomer/self">客户列表</a></li>
		<li class="active"><a href="${ctx}/bg/bgCustomer/selfForm?id=${bgCustomer.id}">客户<shiro:hasPermission name="bg:bgCustomer:self">${not empty bgCustomer.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="bg:bgCustomer:self">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="bgCustomer" action="${ctx}/bg/bgCustomer/save?LH_VIEW_OVERRIDE=/a/bg/bgCustomer/self" method="post" class="form-horizontal disableCopy">
		<form:hidden path="id"/>
					...
					<table id="contentTable" class="table table-striped table-bordered table-condensed">
						<thead>
							<tr>
								...
								<th>固定电话号码</th>
								<th>传真号码</th>
									<shiro:hasPermission name="bg:bgCustomer:self">
									<th width="10">&nbsp;</th>
									</shiro:hasPermission>
							</tr>
						</thead>
						...
						<shiro:hasPermission name="bg:bgCustomer:self"><tfoot>
		...
		<div class="form-actions">
			<shiro:hasPermission name="bg:bgCustomer:self"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
