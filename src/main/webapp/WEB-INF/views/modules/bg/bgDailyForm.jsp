...
<body>
	...
	<form:form id="inputForm" modelAttribute="bgDaily" action="${ctx}/bg/bgDaily/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="todayRemark" htmlEscape="false" rows="4" maxlength="1000" class="input-xxlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">明天重点客户及情况：</label>
			<div class="controls">
				<form:textarea path="tomorrowPlan" htmlEscape="false" rows="4" maxlength="1000" class="input-xxlarge "/>
			</div>
		</div>
